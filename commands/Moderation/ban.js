...
module.exports = {
    ...
    async run (client, message, args){
        ...
        if(!message.member.permissions.has("BAN_MEMBERS")) return message.channel.send({ embeds: [errr]}).catch(e => console.log(e))
        ...
        if(!mentionedMember.bannable) return message.reply({ content: "Unable to ban member", allowedMentions: {repliedUsers: false}})
